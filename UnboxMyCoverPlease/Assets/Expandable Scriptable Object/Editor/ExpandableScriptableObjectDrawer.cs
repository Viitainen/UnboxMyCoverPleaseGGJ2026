...
public class ExpandableScriptableObjectDrawer : PropertyDrawer {
	...
	public override void OnGUI (Rect position, SerializedProperty property, GUIContent label) {
		...
		if(property.objectReferenceValue != null) {
			...
			EditorGUI.PropertyField(new Rect(position.x + EditorGUIUtility.labelWidth, position.y, position.width - EditorGUIUtility.labelWidth, EditorGUIUtility.singleLineHeight), property, GUIContent.none, true);
			...
			if(property.isExpanded) {
				...
				bool isReadOnly = property.objectReferenceValue is ExpandableReadOnlyScriptableObject;
